...
var questions = [
        ...
        {question: "What date did the 2014 Winter Olympics begin?",   choices: ["February 1st", "February 7th", "March 5th", "April 23rd"], correct:1},
        ...
        $(document).on("click", ".submit", function() {
                 ...
                 //This does not work. Want to pull answer from array for each question.//
                                ...
                                score++;
                                alert("That is Correct." + "  " + "Correct Answers :" + " " + score + "   " + "Wrong Answers :" + " " + wrong);
